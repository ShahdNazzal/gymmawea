...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EVOLVA — منصة اللياقة والتغذية للنساء" },
      ...
      { property: "og:title", content: "EVOLVA — منصة اللياقة والتغذية للنساء" },
      ...
      { name: "twitter:title", content: "EVOLVA — منصة اللياقة والتغذية للنساء" },
